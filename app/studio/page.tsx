      ...
      <div className="studio-inner">
        <nav className="studio-nav">
          <div className="studio-brand">
            <span className="mark"><i /><i /><i /></span>Cerebra
          </div>
          <div className="studio-pill">
            <span className="dot" /> STAGE 1 · PROMPT OPTIMIZER&nbsp;·&nbsp;
            {result ? (result.llm_backed ? <b>LLM</b> : <span className="warn">TEMPLATE</span>) : "READY"}
          </div>
        </nav>

        <header className="studio-hero">
          <span className="eyebrow"><i /> RESEARCH-BACKED · REDIS RAG · REALISTIC SHORT-FORM</span>
        ...
        <div className="studio-grid">
          ...
          <section className="card">
            <div className="card-head">BRIEF — VOICE OR TEXT</div>
          ...
          {/* ── PAYLOAD + EVIDENCE ────────────────────────────── */}
          <section style={{ display: "flex", flexDirection: "column", gap: 16 } as CSSProperties}>
            <div className="card">
              <div className="card-head">
                <span>VIDEO-MODEL PAYLOAD {result && <span className={result.cached ? "warn" : "ready"}>{result.cached ? "● CACHED" : "● FRESH"}</span>}</span>
            ...
            {c && (
              <div className="card">
                <div className="card-head">OPTIMIZED CREATIVE</div>
                <div className="meta">
            ...
            {result && (result.retrieved.length > 0 || result.research.length > 0) && (
              <div className="card">
                <div className="card-head">
                  ...
                  <span className={result.rag.verified ? "ready" : "warn"}>
                ...
                <div className="ev">
                  ...
                  {result.research.map((f, i) => (
                    <div className="ev-item" key={`r${i}`}>
                      <div className="ev-score" style={{ color: "var(--s-green)" }}>NEW</div>
                      <div className="ev-body">
                        <b>{f.title}</b>
          ...
          <aside className="card right">
            <div className="card-head"><span>PIKA OUTPUT</span><span className="warn">SEEDANCE 2.0</span></div>
